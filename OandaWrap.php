...
if (defined('TAVURTH_OANDAWRAP') === FALSE) {
    ...
    class OandaWrap
    {
        ...
        protected static function authenticate($curl)
        {
            ...
            $headers = array(
                'X-Accept-Datetime-Format: UNIX', //Milliseconds since epoch
        ...
        public static function instruments()
        {
            ...
            if (empty(self::$instruments))
                self::$instruments = self::get('instruments', array(
        ...
        public static function convert_pair($pair, $amount, $home)
        {
            ...
            return ($homeFirst ? self::convert($pairNames[0], $pairNames[1], $amount) : self::convert($pairNames[1], $pairNames[0], $amount));
        }
        ...
        public static function calc_pip_price($pair, $size, $side = 1)
        {
            ...
            return (self::valid($price = self::price(self::nav_instrument_name($pair, 1)))) ? (self::instrument_pip($pair) / ($side ? $price->bid : $price->ask)) * $size : $price;
        }
        ...
        public static function transactions($number = 50, $pair = 'all')
        {
            ...
            return self::get(self::transaction_index(), array(
                'count' => $number,
                'instrument' => $pair
            ));
        }
        ...
        public static function transactions_type($type, $number = 50, $pair = 'all')
        {
            ...
            return self::transactions_types(array(
                $type
            ), $number, $pair);
        }
        ...
        public static function set_stop($type, $id, $price)
        {
            ...
            return self::set_($type, $id, array(
                'stopLoss' => $price
            ));
        }
        ...
        public static function order_pair($pair, $number = 50)
        {
            ...
            return self::get(self::order_index(), array(
                'instrument' => $pair,
                'count' => $number
            ));
        }
        ...
        public static function order_set_expiry($id, $time)
        {
            ...
            return self::set_('order', $id, array(
                'expiry' => $time
            ));
        }
        ...
        public static function trade_pair($pair, $number = 50)
        {
            ...
            return self::get(self::trade_index(), array(
                'instrument' => $pair,
                'count' => $number
            ));
        }
        ...
        public static function price($pair)
        {
            ...
            return (self::valid($prices = self::prices(array(
                $pair
        ...
        public static function price_time($pair, $date)
        {
            ...
            return (self::valid($candles = self::candles_time($pair, 'S5', ($time = strtotime($date)), $time + 10))) ? $candles->candles[0] : $candles;
        }
        ...
        public static function candles($pair, $gran, $rest = null)
        {
            ...
            //Check the object
            return (self::valid($candles = self::get('candles', $candleOptions))) ? self::candles_times_to_seconds($candles) : $candles;
        }
        
        public static function candles_time($pair, $gran, $start, $end)
        {
            //Return candles for '$pair' between $start and $end
            return self::candles($pair, $gran, array(
                'start' => $start,
                'end' => $end
            ));
        }
